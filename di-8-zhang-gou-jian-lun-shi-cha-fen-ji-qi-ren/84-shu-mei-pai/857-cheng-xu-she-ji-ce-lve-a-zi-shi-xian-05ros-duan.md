### 8.5.7 基于rosserial\_arduino的底盘实现\_05ROS端
...
启动launch文件、rviz与键盘控制节点，rviz中可以添加TF与Odometry组件\(将Global Option 与 Odometry 的 Topic 设置为 odom\)![](/assets/底盘控制.gif)键盘控制底盘运动，在 rviz 中会显示底盘的运动轨迹
